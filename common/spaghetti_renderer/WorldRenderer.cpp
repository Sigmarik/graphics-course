...
void WorldRenderer::loadShaders()
{
  etna::create_program(
    ...
    {SPAGHETTI_RENDERER_SHADERS_ROOT "static_mesh.frag.spv", SPAGHETTI_RENDERER_SHADERS_ROOT "static_mesh.vert.spv"});
  etna::create_program("static_mesh", {SPAGHETTI_RENDERER_SHADERS_ROOT "static_mesh.vert.spv"});
  etna::create_program(
    "deferred_lights",
    {SPAGHETTI_RENDERER_SHADERS_ROOT "deferred_point_lights.frag.spv",
     SPAGHETTI_RENDERER_SHADERS_ROOT "fullscreen.vert.spv"});
  etna::create_program(
    "decal_program",
    {SPAGHETTI_RENDERER_SHADERS_ROOT "decals.frag.spv", SPAGHETTI_RENDERER_SHADERS_ROOT "fullscreen.vert.spv"});
  etna::create_program("cluster_designation", {SPAGHETTI_RENDERER_SHADERS_ROOT "cluster_assign.comp.spv"});
}

  ...
  , useVsync{true}
{
  ...
  etna::create_program("toy", {LOCAL_SHADERTOY2_SHADERS_ROOT "toy.comp.spv"});
...
void App::drawFrame()
{
  ...
  if (nextSwapchainImage)
  {
    ...
    {
      // First of all, we need to "initialize" the "backbuffer", aka the current swapchain
      ...
      // "Transfer" in vulkan means "copy or blit".

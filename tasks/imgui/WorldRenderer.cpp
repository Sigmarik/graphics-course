...
void WorldRenderer::loadShaders()
{
  etna::create_program(
    ...
    {IMGUI_SHADERS_ROOT "static_mesh.frag.spv", IMGUI_SHADERS_ROOT "static_mesh.vert.spv"});
  etna::create_program("static_mesh", {IMGUI_SHADERS_ROOT "static_mesh.vert.spv"});
  etna::create_program(
    "deferred_lights",
    {IMGUI_SHADERS_ROOT "deferred_point_lights.frag.spv",
     IMGUI_SHADERS_ROOT "fullscreen.vert.spv"});
  etna::create_program(
    "decal_program",
    {IMGUI_SHADERS_ROOT "decals.frag.spv", IMGUI_SHADERS_ROOT "fullscreen.vert.spv"});
  etna::create_program("cluster_designation", {IMGUI_SHADERS_ROOT "cluster_assign.comp.spv"});
}
